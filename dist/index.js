        ...
        switch (name) {
            ...
            case "screenshot_capture": {
                ...
                if (selector) {
                    ...
                    if (!element) {
                        throw new McpError(ErrorCode.InvalidParams, `Element with selector "${selector}" not found`);
                    }
            ...
            case "screenshot_viewport": {
                ...
                if (preset && viewportPresets[preset]) {
                    ...
                    throw new McpError(ErrorCode.InvalidParams, "Either preset or width/height must be provided");
                }
